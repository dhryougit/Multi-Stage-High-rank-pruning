...
import config
import constants
from models import my_model, SMPL, densenet121, comp_resnet50, comp_dense, adaptive_densenet
...
parser.add_argument('--checkpoint', default='/home/urp10/SPIN/pruned_model/adaptive_local_densenet4.pt', help='Path to network checkpoint')
...
if __name__ == '__main__':
    ...
    dataname = ['3dpw', 'mpi-inf-3dhp', 'lsp']
    for data in dataname:
        print(data)
        # Setup evaluation dataset
        dataset = BaseDataset(None, data, is_train=False)
        # Run evaluation
        run_evaluation(model, data, dataset, args.result_file,
